...
public class ArrayTasks {
    ...
    public int[] getOnlyPositiveNumbers(int[] arr) {
        ...
        int[] positiveNumbersArray = new int[positiveNumbersAmount];
        int positiveArrayIterator = 0;
        for (int i = 0; i < arr.length && positiveArrayIterator < positiveNumbersArray.length; i++) {
            if (arr[i] > 0) {
                positiveNumbersArray[positiveArrayIterator] = arr[i];
